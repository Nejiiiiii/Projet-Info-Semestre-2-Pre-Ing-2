...
<body style="min-height:100vh; margin:0; padding:0;">
  ...
  <main>
    <div class="box">
      ...
      <form action="resultats.html" method="GET" class="flexbox">
  ...
  <footer>
    <p>© 2025 High WAY. Tous droits réservés. 📍 Paris, France | 📞 +33 1 23 45 67 89 | 📧 contact@HighWAY.fr | Conçu avec 💖 pour pailleter vos vols.✈️</p>
  </footer>
</body>
</html>
